  ...
  return ( 
    <section className='flex py-20 px-6 pg-secondary '>
        ...
        <h1 className='text-primary font-bold text-xl md:text-2xl font-cinzel md:mt-20 md:ml-20'>
            Hi,<br/>
            I'm <span className='text-green-900 text-xl md:text-3xl' >DHARMARAJ </span>  <br/>
        ...
        <a className='text-lg font-cinzel font-bold px-4 py-2 bg-green-600 text-white rounded hover:bg-blue-800 ' target='_blank' href={myResume}>Download My Resume</a>
